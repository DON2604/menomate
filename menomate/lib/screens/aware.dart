            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text("What is the menstrual cycle?",style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                  Container(
                    height:130,
                  ...
                  const Text("Phases of the menstrual cycle",
                  style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold),),
                  Center(child: Image.asset('assets/home/awareness.png', height:200)),
                  const SizedBox(height: 20),
                  // Menstrual Phase Information
                  const Text(
                        "1. Menstrual Phase",
                        style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 79, 2, 2)
                      )
                      ),
                  Container(
                    height:140,
                    ...
                    colors: [ 
                     const Color.fromARGB(255, 245, 95, 95).withOpacity(0.8), 
                     const Color.fromARGB(255, 242, 138, 138).withOpacity(0.8) 
                    ] 
                    ), 
                    boxShadow: const [ 
                      BoxShadow( 
                  ...
                  const Text(
                          "2. Follicular Phase",
                          style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Color.fromARGB(255, 37, 21, 1)),
                  ),
                  Container(
                    height:145,
                    padding:const EdgeInsets.all(3.0),
                    ...
                    gradient: LinearGradient( 
                    colors: [ 
                     const Color.fromARGB(255, 248, 145, 94).withOpacity(0.7), 
                     const Color.fromARGB(255, 247, 162, 116).withOpacity(0.7)
                    ] 
                    ), 
                    boxShadow: const [ 
                      BoxShadow( 
                  ...
                  Container(
                    ...
                    gradient: LinearGradient( 
                    colors: [ 
                     const Color.fromARGB(255, 232, 236, 26).withOpacity(0.6), 
                     const Color.fromARGB(255, 250, 217, 139).withOpacity(0.6)
                    ] 
                    ), 
                    boxShadow: const [ 
                      BoxShadow( 
                  ...
                  Container(
                    ...
                    gradient: LinearGradient( 
                    colors: [ 
                     const Color.fromARGB(255, 249, 78, 78).withOpacity(0.5), 
                     const Color.fromARGB(255, 239, 105, 105).withOpacity(0.5)
                    ] 
                    ), 
                    boxShadow: const [ 
                      BoxShadow( 
                ...
                Stack(
                        ...
                        const Text("Talk to your doctor if you are worried about your periods. For example, if:"),
                        const Text("1.your period patterns change"),
                        const Text("2.your periods are getting heavier (i.e. you need to change your pad or tampon more often than every 2 hours)"),
                        const Text("3.your periods last more than 8 days"),
                        const Text("4.your periods come less than 21 days apart"),
                        const Text("5.your periods come more than 2 to 3 months apart"),
                        const Text("6.your symptoms are so painful they affect your quality of life"),
